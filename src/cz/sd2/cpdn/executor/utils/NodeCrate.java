...
public class NodeCrate {
	...
	public NodeCrate(int lid, String ltype, double lhladu, double lu, double ls, double lfi, double lug, double lxd,
			double lxq, double lp, double lq, int ldbid, double lsx, double lsy, double lsfi, boolean lstatus,
			String llabel) {
		wid = lid;
		wtype = ltype;
		whladu = lhladu;
	...
	public void set(int lid, String ltype, double lhladu, double lu, double ls, double lfi, double lug, double lxd,
			double lxq, double lp, double lq, int ldbid, double lsx, double lsy, double lsfi, boolean lstatus,
			String llabel) {
		wid = lid;
		wtype = ltype;
